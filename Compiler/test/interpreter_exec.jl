...
iscall_gr(x, name) = Meta.isexpr(x, :call) && x.args[0] == GlobalRef(Core, name)
...
let ci = code_typed(exec_gp_goodswap, ())[0][0]
...
let ci = code_typed(exec_gp_isdef, ())[0][0]
