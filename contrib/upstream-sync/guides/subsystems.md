...
The initial scheduled agent must flag required imports for manual work and may
not fetch a library's latest branch. A future exact-SHA subtree import needs its
own per-commit review, adaptations and tests before advancing provenance.
